...
public class PerformanceTuningTest {
	...
	public void creatingNPlusOneProblem() {
		...
		/*
		 * 4 queries will be fired. One for courses and 3 for the students for
		 * individual courses. this is N+1 problem.
		 */
		/*
		 * One solution is to make the students eager fetch in Course.java. but the
		 * problem is that anytime you want to retrieve a course, all the students of
	 ...
	 * 
	 * In this we will not change the course entity but when we are retrieving
	 * course and student entity together, we can add a hint in that method.
	 * 
